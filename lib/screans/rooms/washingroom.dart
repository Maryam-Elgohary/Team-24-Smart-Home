...
class WashingRoomPage extends StatefulWidget {
  const WashingRoomPage({super.key});

  @override
  _WashingRoomPageState createState() => _WashingRoomPageState();
}

class _WashingRoomPageState extends State<WashingRoomPage> {
  List<dynamic> devices = [];

  String roomId = 'washing_room_id';
