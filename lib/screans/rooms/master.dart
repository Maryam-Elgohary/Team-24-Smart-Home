...
class MasterRoomPage extends StatefulWidget {
  const MasterRoomPage({super.key});

  @override
  _MasterRoomPageState createState() => _MasterRoomPageState();
}

class _MasterRoomPageState extends State<MasterRoomPage> {
  List<dynamic> devices = [];

  String roomId = 'master_room_id';
