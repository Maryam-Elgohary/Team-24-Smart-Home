...
class ChildrenRoomPage extends StatefulWidget {
  const ChildrenRoomPage({super.key});

  @override
  _ChildrenRoomPageState createState() => _ChildrenRoomPageState();
}

class _ChildrenRoomPageState extends State<ChildrenRoomPage> {
  List<dynamic> devices = [];

  String roomId = 'children_room_id';
